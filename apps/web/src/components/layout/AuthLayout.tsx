  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:block lg:w-1/2">
        <div className="flex h-full items-center justify-center bg-gradient-to-br from-primary-600 to-primary-800 p-12">
          <div className="max-w-lg text-center text-white">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <div className="rounded-lg bg-white/10 p-4">
                ...
                <div className="text-sm text-primary-200">Storage</div>
              </div>
              <div className="rounded-lg bg-white/10 p-4">
                <div className="text-3xl font-bold">4K</div>
                <div className="text-sm text-primary-200">Video Support</div>
              </div>
              <div className="rounded-lg bg-white/10 p-4">
