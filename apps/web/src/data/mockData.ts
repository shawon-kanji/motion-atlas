...
export const mockComments: Record<string, Comment[]> = {
  "asset-1": [
    ...
    },
    {
      ...
      content:
        "Can we extend this scene by 2 seconds? The pacing feels a bit rushed.",
      timestamp: 45.0,
    ...
    },
    {
      ...
      content:
        "Audio levels are perfect in this version. Approved for publishing!",
  ...
  "asset-2": [
    {
      ...
      userName: "Demo User",
      content:
        "Interesting visual style. Let's discuss the color palette in our next meeting.",
